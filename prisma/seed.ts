...
async function main() {
  ...
  await prisma.company.createMany({
    data: [
      { name: "Infosys", industry: "IT Services", status: ApprovalStatus.APPROVED },
      { name: "TCS", industry: "IT Services", status: ApprovalStatus.APPROVED },
      { name: "Zoho", industry: "SaaS", status: ApprovalStatus.APPROVED },
      { name: "Amazon", industry: "Cloud and Commerce", status: ApprovalStatus.APPROVED },
      { name: "Deloitte", industry: "Consulting", status: ApprovalStatus.PENDING }
    ]
  });
  ...
  const student = await prisma.studentProfile.create({
    data: {
      ...
      verified: true,
      resume: {
        create: { fileName: "ananya-resume.pdf", fileUrl: "/demo/resume.pdf" }
      }
    }
  });
